...
let g:airline#themes#schuam#palette = {}
...
let g:airline#themes#schuam#palette.terminal = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)

let g:airline#themes#schuam#palette.replace = copy(g:airline#themes#schuam#palette.insert)
let g:airline#themes#schuam#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#schuam#palette.replace_modified = g:airline#themes#schuam#palette.insert_modified
...
let g:airline#themes#schuam#palette.accents = {
      \ 'red': [ '' , '' , s:dark_red , ''  ]
      \ }
